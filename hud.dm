...
obj/maskbar/HP
	icon = 'HP.dmi'
	screen_loc = "CENTER:-310,CENTER:165"
	width = 162
	height = 5
	orientation = EAST
obj/maskbar/Stam
	icon = 'Stam.dmi'
	screen_loc = "CENTER:-310,CENTER:145"
	width = 162
	height = 5
	orientation = EAST
obj/maskbar/Shock
	icon = 'Shock.dmi'
	screen_loc = "CENTER:-310,CENTER:125"
	width = 162
	height = 5
	orientation = EAST
client
	proc
		UpdateUI()
			mob.hpbar.setValue(mob.health/mob.maxhealth,1)
			mob.stambar.setValue(mob.stamina/100,1)
			mob.shockbar.setValue(mob.shock/120,1)